        ...
        return ( 
            <React.Fragment>
                ...
                actions={[
                    {
                      ...
                      tooltip: 'Add User',
                      isFreeAction: true,
                      onClick: (event) => {window.location.href ="/ifabricante"}
                    }
                  ]}
                detailPanel = {[{
                    tooltip: 'Visualizar',
                ...
                columns = {[
                    ...
                    {title: 'Nome', field: 'nome_empresa'},
                    {title: 'Cidade', field: 'cidade'},
                    {title: 'Nº de Telefone', field: 'telefone'},
                ]}
