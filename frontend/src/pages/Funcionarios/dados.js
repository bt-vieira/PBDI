...
export default class Dados extends React.Component{
    ...
    setarVal(rowData,cont){
        ...
        this.state.CPTS = rowData.CTPS;
        this.state.Funcao = rowData.Funcao;
        this.state.Salario = rowData.Salario;
        this.state.CRF = rowData.CRF}
                ...
                actions={[
                    {
                      ...
                      tooltip: 'Adicionar',
                      isFreeAction: true,
                      onClick: (event) => {window.location.href ="/ifuncionario"}
                    }
                  ]}
                detailPanel = {[{
                    tooltip: 'Visualizar',
                        ...
                        <div>
                            <form class="pure-form pure-form-stacked" onSubmit = {this.handleEdit} method="PUT">
                                ...
                                <div class="pure-g">
                                    ...
                                    <div class="pure-u-1-4">
                                        <label for="CTPS">CPTS</label>
                                        <input type="text" id="CTPS" name="CTPS" defaultValue={rowData.CTPS} class="pure-input-1" readonly="" />
                                    </div>
                                    ...
                                    <div class="pure-u-1-2">
                                        ...
                                        <input type="text" id="funcao" name="Funcao" onChange={this.handleInputChange} defaultValue={rowData.Funcao} class="pure-input-1" />
                                    </div>
                                    <div class="pure-u-1-4">
                                        <label for="salario">Salário</label>
                                        <input type="text" id="salario" name="Salario" onChange={this.handleInputChange} defaultValue={rowData.Salario} class="pure-input-1" />
                                    </div>
                                    <div class="pure-u-1-4">
                                        <label for="CRF">CRF</label>
                                        <input type="text" id="CRF" name="CRF" onChange={this.handleInputChange} defaultValue={rowData.CRF} class="pure-input-1" />
                                    </div>
                                    ...
                                    <div class="pure-u-1-8">
                                        ...
                                        <input type="radio" id="M" name="genero" onChange={this.handleInputChange} value="M" class="pure-input-1-3" />
                                    </div>
                                    <div class="pure-u-1-8">    
                                        <label for="F">Feminino</label>
                                        <input type="radio" id="F" name="genero" onChange={this.handleInputChange} value="F" class="pure-input-1-3"/>
                                    </div>
                                    <div class="pure-u-1-8">
                                        <label for="N">Outro</label>
                                        <input type="radio" id="N" name="genero" onChange={this.handleInputChange} value="N" class="pure-input-1-3"/>
                                    </div>
                                    <div class="pure-u-1-4">
