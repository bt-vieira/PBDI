...
export default class Dados extends React.Component{
    ...
    setarVal(rowData,cont){
        ...
        this.state.especialidade = rowData.especialidade;
        this.state.registro = rowData.registro;
        }
    }
        ...
        return ( 
            <React.Fragment>
                ...
                actions={[
                    {
                      ...
                      tooltip: 'Add User',
                      isFreeAction: true,
                      onClick: (event) => {window.location.href ="/iprofissional"}
                    }
                  ]}
                detailPanel = {[{
                    tooltip: 'Visualizar',
                            ...
                            <form class="pure-form pure-form-stacked" onSubmit = {this.handleEdit} method="PUT">
                                ...
                                <div class="pure-g">
                                    ...
                                    <div class="pure-u-3-4">
                                        ...
                                        <input type="text" id="especialidade" name="especialidade" onChange={this.handleInputChange} defaultValue={rowData.especialidade} class="pure-input-1" />
                                    </div>
                                    <div class="pure-u-1-4">
                                        <label for="registro">Registro</label>
                                        <input type="text" id="registro" name="registro" onChange={this.handleInputChange} defaultValue={rowData.registro} class="pure-input-1" />
                                    </div>
                ...
                columns = {[
                    ...
                    {title: 'Registro Profissional', field: 'registro'},
                ]}
